    ...
    <body class="min-h-screen bg-base-100 text-base-content antialiased">
        ...
        <main id="top">
            ...
            <section id="projects" class="mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8">
                <div class="grid gap-10 lg:grid-cols-[0.9fr_1fr] lg:items-start">
                    <div>
                    ...
                    <div class="aspect-video overflow-hidden rounded-box border border-base-300 bg-base-200" role="img" aria-label="Placeholder for a hobby project image">
                        <div class="flex h-full items-end justify-between gap-3 p-5">
                            <span class="h-20 flex-1 rounded-box bg-primary/75"></span>
                            <span class="h-32 flex-1 rounded-box bg-accent/65"></span>
                            <span class="h-24 flex-1 rounded-box bg-secondary/70"></span>
                            <span class="h-40 flex-1 rounded-box bg-neutral/80"></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-10 grid gap-5 md:grid-cols-3">
                    <article class="card card-border bg-base-100">
                        <div class="card-body">
                            ...
                            <h3 class="card-title text-lg">DiveLogRepeat</h3>
                            <p class="text-sm leading-6 text-base-content/70">
                    ...
                    <article class="card card-border bg-base-100">
                        <div class="card-body">
                            ...
                            <h3 class="card-title text-lg">Homebrew Helper</h3>
                            <p class="text-sm leading-6 text-base-content/70">
                    ...
                    <article class="card card-border bg-base-100">
                        <div class="card-body">
                            ...
                            <h3 class="card-title text-lg">Small tools</h3>
                            <p class="text-sm leading-6 text-base-content/70">
